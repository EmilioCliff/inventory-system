...
type Querier interface {
	...
	CreateC2BTransaction(ctx context.Context, arg CreateC2BTransactionParams) (C2bTransaction, error)
	...
	GetC2BTransaction(ctx context.Context, transactionID string) (C2bTransaction, error)
