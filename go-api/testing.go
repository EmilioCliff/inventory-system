...
// 	toDate, err := time.Parse("2006-01-02", "2024-08-14")
// 	if err != nil {
// 		log.Fatal().Msgf("Couldnt parse time: %s", err)
// 	}
// 	reportMaker := reports.NewReportMaker(store)

// 	err = reportMaker.GenerateUserExcel(context.Background(), reports.ReportsPayload{
// 		FromDate: fromDate,
// 		ToDate:   toDate,
// 	})
// 	if err != nil {
...
// 	err = reportMaker.GenerateManagerReports(context.Background(), reports.ReportsPayload{
// 		FromDate: fromDate,
// 		ToDate:   toDate,
// 	})
// 	if err != nil {
